                ...
                <div class="form-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control border-primary" value="{{$state->ar_state_name}}" placeholder="{{ trans('admin.ar_state_name') }}"
                              name="ar_state_name" ">
                          </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control border-primary" value="{{$state->en_state_name}}" placeholder="{{ trans('admin.en_state_name') }}"
                              name="en_state_name" ">
                          </div>
                        </div>
                    </div>
